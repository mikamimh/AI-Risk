    ...
    if language == "English":
        if detailed:
            return (
                ...
                f"Regarding calibration, the best overall Brier score was observed for {context['best_brier_model']}. Formal comparison of ROC curves indicated that {context['formal_summary']} In terms of clinical utility, the highest mean net benefit between 5% and 20% was observed for {context['best_dca_model']}. Regarding reclassification, {context['reclass_summary']} Given the low event prevalence typical of cardiac surgical cohorts, AUPRC is reported alongside AUC-ROC as a more sensitive summary of performance for rare events. Overall, these findings indicate that model choice should not rely on discrimination alone, but also on calibration, threshold-dependent performance, and net clinical benefit."
            )
        return (
