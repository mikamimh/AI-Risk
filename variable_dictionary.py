...
VARIABLE_DICTIONARY: List[Dict[str, str]] = [
    ...
    {"variable": "CVA", "definition": "History of stroke or cerebrovascular disease", "origin": "Preoperative", "unit": "Yes/No", "transformation": "Categorical (TargetEncoder)", "in_model": "Yes", "domain": "Comorbidities"},
    ...
    {"variable": "Previous surgery", "definition": "History of prior cardiac surgery", "origin": "Preoperative", "unit": "Yes/No", "transformation": "Categorical (TargetEncoder)", "in_model": "Yes", "domain": "Comorbidities"},
    ...
    {"variable": "Ex-Smoker (Pack-year)", "definition": "Former smoker (pack-years)", "origin": "Preoperative", "unit": "numeric/categorical", "transformation": "Categorical (TargetEncoder)", "in_model": "Yes", "domain": "Comorbidities"},
    ...
    # --- Echocardiographic ---
    {"variable": "LVEF, %", "definition": "Left ventricular ejection fraction", "origin": "Pre-Echocardiogram", "unit": "%", "transformation": "Numeric, continuous", "in_model": "Yes", "domain": "Echocardiographic"},
